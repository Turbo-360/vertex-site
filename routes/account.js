	...
	if (action == 'verifytoken'){
		...
		if (req.body.encode == 'base64'){
			...
			try {
				...
				console.log('base64 token decode failed: ' + err.message)
				throw err
				return
			}
		}
